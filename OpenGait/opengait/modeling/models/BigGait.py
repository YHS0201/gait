...
class BigGait__Dinov3_Gaitbase(BaseModel):
    def build_network(self, model_cfg):
        # get pretained models
        self.pretrained_dinov3 = model_cfg["pretrained_dinov3"]
    ...
    def init_DINOv3(self):
        ...
        self.msg_mgr.log_info(f"=> loaded successfully '{self.pretrained_dinov3}'")
        self.msg_mgr.log_info('DINOv3 Count: {:.5f}M'.format(n_parameters / 1e6))
